 ...
 */
final class Version20241025082411 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notes (id INT AUTO_INCREMENT NOT NULL, id_vin INT NOT NULL, fruit INT DEFAULT NULL, leger INT DEFAULT NULL, faicheur INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE base_vins CHANGE description description VARCHAR(900) NOT NULL, CHANGE contact contact VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE base_vins CHANGE description description VARCHAR(900) DEFAULT NULL, CHANGE contact contact VARCHAR(255) DEFAULT NULL');
