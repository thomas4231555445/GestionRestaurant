 ...
 */
final class Version20241025134323 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE base_vins CHANGE description description VARCHAR(900) NOT NULL, CHANGE contact contact VARCHAR(255) NOT NULL, CHANGE notes_id notes_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE base_vins CHANGE notes_id notes_id INT DEFAULT NULL, CHANGE description description VARCHAR(900) DEFAULT NULL, CHANGE contact contact VARCHAR(255) DEFAULT NULL');
