 ...
 */
final class Version20241112140910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inventaire CHANGE date_enregistrement date_enregistrement DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inventaire CHANGE date_enregistrement date_enregistrement DATETIME DEFAULT NULL');
