 ...
 */
final class Version20241119153751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE base_vins CHANGE notes_id notes_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE inventaire ADD vin_id INT NOT NULL, CHANGE restaurant_id restaurant_id INT NOT NULL, CHANGE date_enregistrement date_enregistrement VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE inventaire ADD CONSTRAINT FK_338920E0B1E7706E FOREIGN KEY (restaurant_id) REFERENCES restaurant (id)');
        $this->addSql('ALTER TABLE inventaire ADD CONSTRAINT FK_338920E0BA62C651 FOREIGN KEY (vin_id) REFERENCES vins (id)');
        $this->addSql('CREATE INDEX IDX_338920E0B1E7706E ON inventaire (restaurant_id)');
        $this->addSql('CREATE INDEX IDX_338920E0BA62C651 ON inventaire (vin_id)');
        ...
        $this->addSql('ALTER TABLE vins ADD CONSTRAINT FK_1A64B65C2E8C07C5 FOREIGN KEY (id_fournisseur) REFERENCES fournisseurs (id)');
        ...
        $this->addSql('CREATE INDEX IDX_1A64B65C2E8C07C5 ON vins (id_fournisseur)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE base_vins CHANGE notes_id notes_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE inventaire DROP FOREIGN KEY FK_338920E0BA62C651');
        $this->addSql('DROP INDEX IDX_338920E0B1E7706E ON inventaire');
        $this->addSql('DROP INDEX IDX_338920E0BA62C651 ON inventaire');
        $this->addSql('ALTER TABLE inventaire DROP vin_id, CHANGE restaurant_id restaurant_id INT DEFAULT NULL, CHANGE date_enregistrement date_enregistrement VARCHAR(255) DEFAULT NULL');
