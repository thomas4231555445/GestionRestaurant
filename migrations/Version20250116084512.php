 ...
 */
final class Version20250116084512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carte (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, background VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, nom_etablissement VARCHAR(255) NOT NULL, selection VARCHAR(10000) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE inventaire CHANGE restaurant_id restaurant_id INT NOT NULL, CHANGE date_enregistrement date_enregistrement VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inventaire CHANGE restaurant_id restaurant_id INT DEFAULT NULL, CHANGE date_enregistrement date_enregistrement VARCHAR(255) DEFAULT NULL');
